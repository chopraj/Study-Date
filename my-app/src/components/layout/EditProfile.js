...
const EditProfile = ({logout, profile: {profile, loading}, createProfile, getCurrentProfile}) => {
    ...
    useEffect(() => {
        ...
        setFormData({
            ...
            contact_email: loading || !profile.contact_email ? '': profile.contact_email
        })
    }, [loading])
...
<Alert/>
        ...
        <form className="form" onSubmit={e => onSubmit(e)}>
                ...
                <div className="form-group">
                    <input value={bio} onChange={e=> onChange(e)} type="text" maxlength='200' placeholder="Bio" name="bio" />
...
export default connect(mapStateToProps, {logout, createProfile, getCurrentProfile})(EditProfile)
